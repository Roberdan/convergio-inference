...
[![CI](https://github.com/Roberdan/convergio-inference/actions/workflows/ci.yml/badge.svg)](https://github.com/Roberdan/convergio-inference/actions/workflows/ci.yml)
[![License: Convergio Community](https://img.shields.io/badge/license-Convergio%20Community-blue)](https://github.com/Roberdan/convergio-inference/blob/main/LICENSE)
[![Rust](https://img.shields.io/badge/rust-stable-orange)](https://www.rust-lang.org/)
[![Zero Warnings](https://img.shields.io/badge/warnings-0-brightgreen)](#)

LLM inference router — model selection, streaming, cost tracking
...
```mermaid
graph LR
    CRATE[convergio-inference] --> SDK[convergio-sdk]
    SDK --> T[types]
    SDK --> TEL[telemetry]
    SDK --> DB[db]
    SDK --> SEC[security]
...
```toml
[dependencies]
convergio-inference = { git = "https://github.com/Roberdan/convergio-inference", tag = "v0.1.0" }
```
